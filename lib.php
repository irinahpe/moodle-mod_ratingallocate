 ...
 *                        will know about or false if $coursemodule not found.
 */
function ratingallocate_get_coursemodule_info($coursemodule) {
    ...
    if (!$ratingallocate = $DB->get_record('ratingallocate', $dbparams, $fields)) {
        return false;
    }
    ...
    if ($coursemodule->completion == COMPLETION_TRACKING_AUTOMATIC) {
        $result->customdata['customcompletionrules']['votetrackingenabled'] = $ratingallocate->votetrackingenabled;
        $result->customdata['customcompletionrules']['assignedtrackingenabled'] = $ratingallocate->assignedtrackingenabled;
    }

    /*
    // This can be used in calendar or on dashboard.
